export default {
  ...
  login: {
    ...
    lanAddressLabel: 'LAN Address (Priority)',
    lanAddressPlaceholder: 'e.g. http://10.1.1.50:80',
    wanAddressLabel: 'WAN Address (Fallback)',
    wanAddressPlaceholder: 'e.g. https://example.com',
    addressRequired: 'Please enter at least one server address',
    addressChecking: 'Checking server connectivity...',
    addressCheckingLan: 'Checking LAN address...',
    addressCheckingWan: 'Checking WAN address...',
    allAddressesUnreachable: 'All addresses unreachable — check network or address',
    addressReachable: '{addr} is reachable',
  },
