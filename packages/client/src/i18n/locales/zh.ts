export default {
  ...
  login: {
    ...
    lanAddressLabel: '内网地址（优先）',
    lanAddressPlaceholder: '例如: http://10.1.1.50:80',
    wanAddressLabel: '外网地址（备用）',
    wanAddressPlaceholder: '例如: https://example.com',
    addressRequired: '请至少输入一个服务器地址',
    addressChecking: '正在检测服务器地址...',
    addressCheckingLan: '正在检测内网地址...',
    addressCheckingWan: '正在检测外网地址...',
    allAddressesUnreachable: '所有地址均无法连接，请检查网络或地址',
    addressReachable: '{addr} 连接正常',
  },
  ...
  chat: {
    ...
    voiceInputNotSupported: '当前浏览器不支持语音输入',
